...
const sipLearningSchema = new mongoose.Schema({
  title: {
    type: String,
...
sipLearningSchema.index({ difficulty: 1 });
sipLearningSchema.index({ isPublished: 1 });
sipLearningSchema.index({ tags: 1 });
sipLearningSchema.index({ createdBy: 1 });
sipLearningSchema.index({ createdAt: -1 });

module.exports = mongoose.model('SIPLearning', sipLearningSchema);
