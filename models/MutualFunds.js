...
mutualFundsSchema.index({ difficulty: 1 });
mutualFundsSchema.index({ isPublished: 1 });
mutualFundsSchema.index({ tags: 1 });
mutualFundsSchema.index({ createdBy: 1 });
mutualFundsSchema.index({ createdAt: -1 });
